...
public class MainPila extends PApplet {
    ...
    // Propiedad/Atributo/Objeto(s) de la classe
    Pila p;
    int lastPushed = -1, lastPopped = -1;

    public static void main(String[] args){
        PApplet.main("EstructuresDeDades.MainPila");
    }
    ...
    public void draw(){
        ...
        textSize(20);
        text("(A for PUSH and R for POP)", width*0.80f, height*0.2f);
